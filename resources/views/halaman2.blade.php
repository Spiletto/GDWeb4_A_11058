...
<head>
    ...
    <title>GD 4 Halaman 2 - Marselinus Dira Agaska</title>
...
<fieldset>
    ...
    <table style="width:100%; border-collapse: collapse;">
        ...
        <tr>
            ...
            <td></td>
            <td class="sesi">Pemrograman Berbasis Platform (T)</td>
            <td></td>
            <td></td>
        </tr>
        <tr>
            ...
            <td class="sesi">Forensik Digital</td>
            <td class="sesi">Pemprograman Berbasis Platform (P)</td>
